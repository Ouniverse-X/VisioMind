...
from visiomind.action.shared.enums import AgentName
...
def main() -> None:
    from visiomind.action.entrypoints.examples.closed_loop import main as closed_loop_main
    from visiomind.action.runtime.assembly import runtime_builder
