...
from visiomind.action.agents.vision.tools import VisionPhotoCaptureTool, scene_report
...
from visiomind.action.shared.contracts import AgentCapability, MemoryAdapter, ToolInvocation, VisionAdapter
