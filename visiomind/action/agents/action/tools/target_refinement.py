...
from visiomind.action.shared.action_semantics import action_instruction, normalize_action_name
from visiomind.action.shared.context import ExecutionContext, MemorySnapshot, Subtask
from visiomind.action.shared.contracts import MemoryAdapter
