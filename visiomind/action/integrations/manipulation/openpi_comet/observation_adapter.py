    ...
    def convert(
        ...
        *,
        ...
        for key, value in source.items():
            ...
            elif key in _VISIOMIND_ACTION_RGB_ALIASES:
                payload[_VISIOMIND_ACTION_RGB_ALIASES[key]] = OpenPICometObservationAdapter._rgb(value)
