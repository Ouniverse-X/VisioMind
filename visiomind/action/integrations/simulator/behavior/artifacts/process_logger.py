...
import numpy as np
from visiomind.action.runtime.telemetry.process_trace import build_event_record, write_event_record
from visiomind.action.runtime.telemetry.navigation_payloads import summarize_navigation_progress_entry
