...
| 工业场景模型训练/微调 | `training/`、`models/qwen25_3b_industrial_lora/` | Qwen2.5-3B LoRA 权重与哈希；Prompt-only→LoRA：Schema 0.00%→100.00%、意图 80.06%→98.60%、槽位 F1 39.44%→95.47% | 已提交工业大模型 LoRA、五个数据 split、完整评估和许可文件 |
