...
from visiomind.perception.industrial_detector import CLASS_TO_ID
...
PART_COLORS = {
    ...
    "wrench": (210, 215, 220),
    "roller": (160, 165, 170),
    "screwdriver": (220, 60, 40),
    "pliers": (40, 100, 210),
    "nut": (175, 180, 185),
    "screw": (150, 155, 160),
    "allen_wrench": (60, 60, 65),
    "flashlight": (30, 30, 35),
    "toolbox": (200, 140, 30),
    "parts_bin": (30, 120, 180),
    "packing_box": (190, 150, 100),
}
...
def render_scene(
    ...
    chosen_classes = rng.choice(
        TARGET_CLASSES, size=min(num_objects, len(TARGET_CLASSES)), replace=False
    )
...
def generate_dataset(
    output_dir: Path, num_train: int = 150, num_val: int = 40, num_test: int = 40
) -> dict[str, Any]:
