...
from voltron.config_loader import add_config_argument
...
def _add_behavior_runtime_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Disabled by default; Voltron Vision completion remains the primary completion path."
        ),
    )
...
def _add_service_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        choices=["raw", "dict"],
        default="raw",
        help="raw: pass native robot_r1 23D actions; dict: split into Voltron action.* keys.",
    )
...
def _add_navigation_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help="Pinned Nav2 runtime profile. Use this instead of mixing ROS packages into the Voltron env.",
    )
    parser.add_argument(
        "--nav2-action-name",
        type=str,
