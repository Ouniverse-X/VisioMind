...
1. **工业工件抓取与格位放置演示 (`visiomind_industrial_demo.mp4`)**
   - **展示内容**：系统接收到“请把混杂工位上的钳子放进工具箱第三格”指令后，在混杂零件工位（`outfit_a_basic_toolbox` 场景）对钳子进行识别、AnyGrasp 6-DoF 侧向夹紧抓取、非工作臂静止锁定、携物安全导航以及精确对齐并投放至工具箱第 3 格的全流程物理执行过程，包含完整的片头说明卡、任务规划时序卡、实时状态机进度条以及终态验收物理证据卡。
   - **视频对应运行**：`plier_to_toolbox_cell3_industrial_i00_20260825_103300`
   - **规格**：720p (1280×720)，H.264 / 30 fps，时长 139 秒，大小 33.6 MB
   - **SHA-256**：`862f1d2e016b319d1bedf3416c03f3b8cf7c4f00ad62a69006b66f8d3b5e0ac0`
